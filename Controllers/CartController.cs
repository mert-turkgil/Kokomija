    ...
    public class CartController : Controller
    {
        ...
        public async Task<IActionResult> GetCartItems()
        {
            ...
            var cartItems = items.Select(c => new
            {
                ...
                colorId = c.ColorId,
                colorName = c.Color?.DisplayName ?? c.Color?.Name,
                sizeId = c.SizeId,
                sizeName = c.Size?.DisplayName ?? c.Size?.Name,
                quantity = c.Quantity,
            ...
            Coupon? appliedCoupon = null)
        {
            ...
            foreach (var cartItem in cartItems)
            {
                ...
                var itemViewModel = new CartItemViewModel
                {
                    ...
                    ColorName = cartItem.Color?.DisplayName ?? cartItem.Color?.Name,
                    ColorHex = cartItem.Color?.HexCode,
                    SizeId = cartItem.SizeId,
                    SizeName = cartItem.Size?.DisplayName ?? cartItem.Size?.Name,
